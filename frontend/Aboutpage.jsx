...
const TEAM = [
  { name: "Aanya Mehta", role: "Co-Founder & CEO", desc: "Ex-Google PM. Passionate about fixing broken hiring systems.", emoji: "👩‍💼" },
  { name: "Rohan Sinha", role: "Co-Founder & CTO", desc: "Built ML systems at Flipkart. IIT Bombay CS grad.", emoji: "👨‍💻" },
  { name: "Neha Joshi", role: "Head of Product", desc: "Previously led product at CRED. Design-first thinker.", emoji: "🎨" },
  { name: "Vikram Das", role: "Head of AI/ML", desc: "PhD in NLP from IISc. Published researcher in skill extraction.", emoji: "🧠" },
];
  ...
  return (
    <div style={S.root}>
      ...
      <section style={S.section}>
        <div style={S.missionGrid}>
          <div style={S.missionLeft}>
            ...
            <p style={S.secSub} style={{ color: "#c0c0d8", lineHeight: 1.8 }}>
      ...
      <section style={S.cta}>
        ...
        <p style={S.ctaSub}>Join 50,000+ professionals using SJ_Map to find their perfect match.</p>
