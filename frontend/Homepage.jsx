  ...
  return (
    <div style={S.root}>
      ...
      <section style={S.hero}>
        ...
        <div style={{ ...S.chip, top: "20%", left: "7%" }}>⚡ 94% Match Accuracy</div>
        <div style={{ ...S.chip, top: "32%", right: "6%", animationDelay: "0.6s" }}>🏆 3.2x Faster Hiring</div>
        <div style={{ ...S.chip, bottom: "16%", left: "9%", animationDelay: "1.1s" }}>🌱 50K+ Candidates</div>
      </section>
      ...
      <section style={S.section}>
        ...
        <p style={S.sub}>Six intelligent modules eliminating guesswork from recruitment.</p>
        <div style={S.grid}>
          {FEATURES.map((f, i) => (
      ...
      <section style={S.section}>
        ...
        <div style={S.impactGrid}>
          {[
            { icon: "⚡", t: "Faster Hiring", d: "Reduce time-to-hire by up to 60% with pre-ranked, AI-screened candidates." },
