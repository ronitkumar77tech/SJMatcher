...
const S = {
  ...
  page: { display: "flex", alignItems: "stretch", minHeight: "calc(100vh - 65px)", position: "relative", zIndex: 1 },
  box: { flex: "0 0 480px", padding: "4rem 3.5rem", borderRight: "1px solid rgba(108,92,231,0.2)", display: "flex", flexDirection: "column" },
